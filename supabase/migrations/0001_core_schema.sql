...
--    Student_ID IS the student's school_id (written on the NFC card),
--    not an auto-generated UUID. Only School_ID/First_Name/Last_Name
--    are ever collected from a student; NFC_UID is bound automatically
--    from the tap itself.
-- ------------------------------------------------------------
